...
- Name: otp.spec.ts >> OTP Verification >> OTP input accepts numeric characters
- Location: tests\otp.spec.ts:29:7
...
Call log:
  - waiting for locator('input[type="text"][maxlength="1"]').first()
