...
- Name: otp.spec.ts >> OTP Verification >> OTP page has back to login link
- Location: tests\otp.spec.ts:23:7
...
Locator: locator('a:has-text("Back"), a:has-text("Login")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("Back"), a:has-text("Login")').first()
