...
- Name: profile.spec.ts >> Profile Page >> profile page has logout button
- Location: tests\profile.spec.ts:32:7
...
Locator: locator('button:has-text("Logout"), button:has-text("Sign Out")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Logout"), button:has-text("Sign Out")')
