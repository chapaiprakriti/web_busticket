...
- Name: otp.spec.ts >> OTP Verification >> OTP page has resend option
- Location: tests\otp.spec.ts:17:7
...
Locator: locator('a:has-text("Resend"), button:has-text("Resend")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("Resend"), button:has-text("Resend")')
