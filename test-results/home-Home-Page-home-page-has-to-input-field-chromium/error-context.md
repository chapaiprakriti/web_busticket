...
- Name: home.spec.ts >> Home Page >> home page has to input field
- Location: tests\home.spec.ts:27:7
...
Locator: locator('input[placeholder*="to" i]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder*="to" i]')
